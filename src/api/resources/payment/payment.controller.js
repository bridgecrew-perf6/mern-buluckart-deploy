...
export default {
    ...
    async orderDetails(req, res, next) {
        const instance = new Razorpay({
            key_id:  'rzp_test_t1nce4Eh7Jo9Zi',
            key_secret: 'UUgZiViDXQKNsGH4KLLcEIVV',
    ...
    async findOrderList(req, res, next) {
        const instance = new Razorpay({
            key_id: process.env.RAZORPAY_KEY_ID || 'rzp_test_t1nce4Eh7Jo9Zi',
            key_secret: process.env.RAZORPAY_SECRET || 'UUgZiViDXQKNsGH4KLLcEIVV',
        });
        try {
